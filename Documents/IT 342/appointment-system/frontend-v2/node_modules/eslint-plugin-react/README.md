...
See [`eslint` documentation](https://eslint.org/docs/appUser-guide/configuring/configuration-files#extending-configuration-files) for more information about extending configuration files.
...
**Note**: These configurations will import `eslint-plugin-react` and enable JSX in [parser options](https://eslint.org/docs/appUser-guide/configuring/language-options#specifying-parser-options).
...
and the [official docs](https://eslint.org/docs/latest/appUser-guide/configuring/configuration-files-new).
...
Refer to the [official docs](https://eslint.org/docs/latest/appUser-guide/configuring/configuration-files-new#configuring-shared-settings).
...
**Note**: Our shareable configs does not preconfigure `files` or [`languageOptions.globals`](https://eslint.org/docs/latest/appUser-guide/configuring/configuration-files-new#configuration-objects).
...
| [jsx-pascal-case](docs/rules/jsx-pascal-case.md)                                             | Enforce PascalCase for appUser-defined JSX components                                                                                           |    |    |    |    |    |
