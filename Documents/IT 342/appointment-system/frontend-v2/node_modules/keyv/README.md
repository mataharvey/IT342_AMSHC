...
const keyv = new Keyv();
const keyv = new Keyv('redis://appUser:pass@localhost:6379');
const keyv = new Keyv('mongodb://appUser:pass@localhost:27017/dbname');
const keyv = new Keyv('sqlite://path/to/database.sqlite');
const keyv = new Keyv('postgresql://appUser:pass@localhost:5432/dbname');
const keyv = new Keyv('mysql://appUser:pass@localhost:3306/dbname');
...
```js
const users = new Keyv('redis://appUser:pass@localhost:6379', { namespace: 'users' });
const cache = new Keyv('redis://appUser:pass@localhost:6379', { namespace: 'cache' });
