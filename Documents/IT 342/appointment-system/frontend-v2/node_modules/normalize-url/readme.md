...
```js
normalizeUrl('appUser:password@sindresorhus.com');
//=> 'https://sindresorhus.com'

normalizeUrl('appUser:password@sindresorhus.com', {stripAuthentication: false});
//=> 'https://appUser:password@sindresorhus.com'
```
