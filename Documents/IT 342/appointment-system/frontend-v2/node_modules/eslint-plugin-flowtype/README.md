...
See [ESLint documentation](http://eslint.org/docs/appUser-guide/configuring#extending-configuration-files) for more information about extending configuration files.
