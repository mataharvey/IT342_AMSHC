...
- Added a clear() function to the request and response interceptors object so a appUser can ensure that all interceptors have been removed from an axios instance [#4248](https://github.com/axios/axios/pull/4248)
