...
import userReducer from './reducer/appUser'; // Reaching to "./reducer/appUser" is not allowed
...
export * from './reducer/appUser'; // Reaching to "./reducer/appUser" is not allowed
```
