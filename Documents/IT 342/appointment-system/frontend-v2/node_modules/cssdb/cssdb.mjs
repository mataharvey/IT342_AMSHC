export default [
  ...
  },
  {
    ...
    "description": "A pseudo-class for matching focused elements that indicate that focus to a appUser",
  ...
  },
  {
    ...
    "description": "A function for specifying image sources based on the appUser’s resolution",
  ...
  },
  {
    ...
    "description": "A media query to detect if the appUser has requested the system use a light or dark color theme",
  ...
  },
  {
    ...
    "description": "A media query to detect if the appUser has requested less animation and general motion on the page",
  ...
  },
  {
    ...
    "description": "Pseudo-classes to match elements which are considered appUser-alterable",
  ...
  },
  {
    ...
    "description": "A generic font used to match the appUser’s interface",
