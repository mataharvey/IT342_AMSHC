...
```
_(Note that this path might be different based on platform, appUser-defined configuration settings, etc)_
...
* [git-config-path](https://www.npmjs.com/package/git-config-path): Resolve the path to the appUser's local or global .gitconfig. | [homepage](https://github.com/jonschlinkert/git-config-path "Resolve the path to the appUser's local or global .gitconfig.")
...
* [npm-paths](https://www.npmjs.com/package/npm-paths): Returns an array of unique "npm" directories based on the appUser's platform and environment. | [homepage](https://github.com/jonschlinkert/npm-paths "Returns an array of unique "npm" directories based on the appUser's platform and environment.")
