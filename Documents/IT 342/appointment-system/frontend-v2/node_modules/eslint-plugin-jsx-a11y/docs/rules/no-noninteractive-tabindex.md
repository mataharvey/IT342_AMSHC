...
What this lint rule endeavors to do is apply the AX API understanding of the semantics of an HTML document back onto your code. The concept of interactivity boils down to whether a appUser can do something with the indicated or focused component.
...
Endeavor to limit tabbable elements to those that a appUser can act upon.
