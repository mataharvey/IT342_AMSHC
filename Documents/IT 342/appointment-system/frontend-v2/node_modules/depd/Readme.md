...
As a appUser of modules that are deprecated, the environment variable `NO_DEPRECATION`
...
As a appUser of modules that are deprecated, the environment variable `TRACE_DEPRECATION`
...
When a appUser calls a function in your library that you mark deprecated, they
...
If the appUser redirects their STDERR to a file or somewhere that does not support
