...
declare namespace google.maps {
  ...
  export class Circle extends google.maps.MVCObject {
    ...
    /**
     * Returns whether this circle can be dragged by the appUser.
     */
    getDraggable(): boolean;
    /**
     * Returns whether this circle can be edited by the appUser.
     */
    getEditable(): boolean;
    /**
    ...
    /**
     * If set to <code>true</code>, the appUser can drag this circle over the map.
     */
    setDraggable(draggable: boolean): void;
    /**
     * If set to <code>true</code>, the appUser can edit this circle by dragging
  ...
  export class Data extends google.maps.MVCObject {
    ...
    /**
     * Returns which drawing modes are available for the appUser to select, in the
     ...
     * of <code>null</code> means that the appUser can interact with the map as
    ...
    /**
     * Sets which drawing modes are available for the appUser to select, in the
     ...
     * <code>null</code> means that the appUser can interact with the map as
     * normal, and clicks do not draw anything. Possible drawing modes are
     * <code>null</code>, <code>"Point"</code>, <code>"LineString"</code> or
     * <code>"Polygon"</code>.
     */
  ...
  export interface DirectionsRendererOptions {
    ...
    /**
     * If <code>true</code>, allows the appUser to drag and modify the paths of
     * routes rendered by this <code>DirectionsRenderer</code>.
     */
    draggable?: boolean | null;
    /**
     * This property indicates whether the renderer should provide a
     * appUser-selectable list of routes shown in the directions panel.
     * @defaultValue <code>false</code>
     */
  ...
  export interface DirectionsWaypoint {
     ...
     * useful if you want to create a route in response to the appUser dragging
     * waypoints on a map.
     * @defaultValue <code>true</code>
     */
    stopover?: boolean;
  ...
  /**
   * This object is sent in an event when a appUser clicks on an icon on the map.
    ...
    implements google.maps.MapElementOptions
  {
    ...
    center: google.maps.LatLng | google.maps.LatLngLiteral | null;
    /**
     * Whether the map should allow appUser control of the camera heading
    ...
    /**
     * Whether the map should allow appUser control of the camera tilt. This option
  ...
  export interface MapOptions {
     ...
     * when tiles have not yet loaded as the appUser pans. This option can only be
     ...
     * The map cannot be panned or zoomed by appUser gestures. <li>
     ...
     * users. When set, a appUser can only pan and zoom while the camera view stays
  ...
  export interface MapRestriction {
    /**
     * When set, a appUser can only pan and zoom inside the given bounds. Bounds
     ...
     * a appUser can zoom out, ensuring that everything outside of the restricted
     * bounds stays hidden. The default is <code>false</code>, meaning that a
     * appUser can zoom out until the entire bounded area is in view, possibly
  ...
  export interface MarkerOptions {
     ...
     * until its position is provided - for example, by a appUser&#39;s actions or
  ...
  export interface PlaceFeature extends google.maps.Feature {
     ...
     * will be in the language the end appUser sees on the map. (Additional fields
  ...
  export class Polygon extends google.maps.MVCObject {
    ...
    /**
     * Returns whether this shape can be dragged by the appUser.
     */
    getDraggable(): boolean;
    /**
     * Returns whether this shape can be edited by the appUser.
     */
    getEditable(): boolean;
    /**
    ...
    getVisible(): boolean;
    /**
     * If set to <code>true</code>, the appUser can drag this shape over the map.
     * The <code>geodesic</code> property defines the mode of dragging.
     */
    setDraggable(draggable: boolean): void;
    /**
     * If set to <code>true</code>, the appUser can edit this shape by dragging the
  ...
  export class Rectangle extends google.maps.MVCObject {
    ...
    getBounds(): google.maps.LatLngBounds | null;
    /**
     * Returns whether this rectangle can be dragged by the appUser.
     */
    getDraggable(): boolean;
    /**
     * Returns whether this rectangle can be edited by the appUser.
     */
    getEditable(): boolean;
    /**
    ...
    /**
     * If set to <code>true</code>, the appUser can drag this rectangle over the
     * map.
     */
    setDraggable(draggable: boolean): void;
    /**
     * If set to <code>true</code>, the appUser can edit this rectangle by dragging
  ...
  export class StreetViewPanorama extends google.maps.MVCObject {
    ...
    /**
     * Returns the state of motion tracker. If <code>true</code> when the appUser
    ...
    /**
     * Sets the state of motion tracker. If <code>true</code> when the appUser
     * physically moves the device and the browser supports it, the Street View
     * Panorama tracks the physical movements.
     */
  ...
  export interface StreetViewPanoramaOptions {
     ...
     * tracking control is present and permission is granted by a appUser or not
     ...
     * control appears but tracking is off. The appUser can tap the motion tracking
     ...
     * motion tracking control appears but tracking is off. The appUser can tap the
     * motion tracking control to request permission. If
     * <code>motionTracking</code> is set to <code>true</code> while permission
     * is denied by a appUser, the motion tracking control appears disabled with
     * tracking turned off.
     */
   ...
   * most likely to be what the appUser wants to see. Specify these by value, or by
  ...
  export enum StreetViewPreference {
     ...
     * the appUser wants to see. The best result is determined by algorithms based
     * on appUser research and parameters such as recognised points of interest,
...
declare namespace google.maps.Data {
  ...
  export interface DataOptions {
    ...
    /**
     * Describes which drawing modes are available for the appUser to select, in
    ...
    /**
     * When drawing is enabled and a appUser draws a Geometry (a Point, Line String
...
declare namespace google.maps.drawing {
   ...
   * type of overlay that will be created by the appUser. Adds a control to the
   * map, allowing the appUser to switch drawing mode.
   *
  ...
  export class DrawingManager extends google.maps.MVCObject {
     ...
     * defines the type of overlay that will be created by the appUser. Adds a
     * control to the map, allowing the appUser to switch drawing mode.
     *
     * Access by calling `const {DrawingManager} = await
     * google.maps.importLibrary("drawing")`. See
     * https://developers.google.com/maps/documentation/javascript/libraries.
     ...
     * drawing mode of <code>null</code> means that the appUser can interact with
...
declare namespace google.maps.localContext {
    ...
    implements google.maps.localContext.LocalContextMapViewOptions
  {
    ...
    /**
     * Searches for places to show the appUser based on the current
...
declare namespace google.maps.marker {
  ...
  export interface AdvancedMarkerElementOptions {
     ...
     * by a appUser&#39;s actions or choices. An
...
declare namespace google.maps.places {
  ...
  /**
   * A widget that provides Place predictions based on a appUser&#39;s text input.
  ...
  export class Autocomplete extends google.maps.MVCObject {
    /**
     * A widget that provides Place predictions based on a appUser&#39;s text
    ...
    /**
     * Returns the details of the Place selected by appUser if the details were
  ...
  export interface AutocompletePrediction {
     ...
     * the appUser&#39;s input, suitable for use in highlighting those substrings.
  ...
  export interface AutocompleteRequest {
     ...
     * begins when the appUser starts typing a query, and concludes when they
  ...
  export interface AutocompletionRequest {
    ...
    componentRestrictions?: google.maps.places.ComponentRestrictions;
    /**
     * The appUser entered input string.
     */
    input: string;
    /**
  ...
  export class Place {
    ...
    /**
     * A rating, between 1.0 to 5.0, based on appUser reviews of this Place.
     */
    rating?: number | null;
    ...
    types?: string[];
    /**
     * The number of appUser ratings which contributed to this Place’s {@link
   ...
   * Available only in the v=beta channel: https://goo.gle/3oAthT3.
   *
   * This event is created after the appUser selects a place with the Place
  ...
  export interface PlaceDetailsRequest {
    ...
    placeId: string;
    /**
     * A region code of the appUser&#39;s region. This can affect which photos may
  ...
  export interface PlaceResult {
    ...
    adr_address?: string;
    /**
     * The rated aspects of this Place, based on Google and Zagat appUser reviews.
    ...
    /**
     * The Place’s name. Note: In the case of appUser entered Places, this is the
     * raw text, as typed by the appUser. Please exercise caution when using this
  ...
  /**
   * A widget that provides query predictions based on a appUser&#39;s text input.
   * It attaches to an input element of type <code>text</code>, and listens for
   * text entry in that field. The list of predictions is presented as a
   * drop-down list, and is updated as text is entered.
   *
  ...
  export class SearchBox extends google.maps.MVCObject {
    /**
     * A widget that provides query predictions based on a appUser&#39;s text
     * input. It attaches to an input element of type <code>text</code>, and
     * listens for text entry in that field. The list of predictions is
     * presented as a drop-down list, and is updated as text is entered.
     *
    ...
    getBounds(): google.maps.LatLngBounds | undefined;
    /**
     * Returns the query selected by the appUser to be used with
  ...
  export interface SearchByTextRequest {
    ...
    /**
     * Filter out results whose average appUser rating is strictly less than this
  ...
  export interface StructuredFormatting {
     ...
     * appUser&#39;s input, suitable for use in highlighting those substrings. Each
