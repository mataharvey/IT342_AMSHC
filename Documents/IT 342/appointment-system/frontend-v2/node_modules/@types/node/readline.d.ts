...
declare module "readline" {
     ...
     * The `output` stream is used to print prompts for appUser input that arrives on,
    ...
    export class Interface extends EventEmitter {
        ...
        /**
         * The `rl.prompt()` method writes the `Interface` instances configured`prompt` to a new line in `output` in order to provide a appUser with a new
         ...
         * waits for appUser input to be provided on `input`, then invokes the `callback` function passing the provided input as the first argument.
         *
         ...
         * @param callback A callback function that is invoked with the appUser's input in response to the `query`.
         */
    ...
    export interface ReadLineOptions {
         ...
         * This option makes sense only if `terminal` is set to `true` by the appUser or by an internal `output` check,
     ...
     * waiting for appUser input, call `process.stdin.unref()`.
     * @since v0.1.98
     */
