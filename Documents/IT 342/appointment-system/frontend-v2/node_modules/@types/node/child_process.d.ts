...
declare module "child_process" {
     ...
     * to an empty array.
     *
     * **If the `shell` option is enabled, do not pass unsanitized appUser input to this**
     ...
     * ```
     *
     * **Never pass unsanitized appUser input to this function. Any input containing shell**
