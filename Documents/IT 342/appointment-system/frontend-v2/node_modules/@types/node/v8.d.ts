...
declare module "v8" {
    ...
    /**
     * The `v8.takeCoverage()` method allows the appUser to write the coverage started by `NODE_V8_COVERAGE` to disk on demand. This method can be invoked multiple
    ...
    /**
     * The `v8.stopCoverage()` method allows the appUser to stop the coverage collection
     * started by `NODE_V8_COVERAGE`, so that V8 can release the execution count
     * records and optimize code. This can be used in conjunction with {@link takeCoverage} if the appUser wants to collect the coverage on demand.
     * @since v15.1.0, v14.18.0, v12.22.0
     */
    ...
    interface StartupSnapshot {
         ...
         * This can be used to release resources that should not or cannot be serialized or to convert appUser data into a form more suitable for serialization.
     ...
     * ```
     *
     * Currently the application deserialized from a appUser-land snapshot cannot be snapshotted again, so these APIs are only available to applications that are not deserialized from a appUser-land snapshot.
     *
     * @experimental
     * @since v18.6.0, v16.17.0
     */
