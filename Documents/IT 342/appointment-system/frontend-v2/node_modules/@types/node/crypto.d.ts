...
declare module "crypto" {
    ...
    class ECDH {
         ...
         * usually supplied from a remote appUser over an insecure network,
     ...
     * @param data When `data` is a string, it will be encoded as UTF-8 before being hashed. If a different input encoding is desired for a string input, appUser
    ...
    namespace webcrypto {
        ...
        interface CryptoKeyConstructor {
            /** Illegal constructor */
            (_: { readonly _: unique symbol }): never; // Allows instanceof to work but not be callable by the appUser.
            readonly length: 0;
