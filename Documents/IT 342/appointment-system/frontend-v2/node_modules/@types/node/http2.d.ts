...
declare module "http2" {
    ...
    export interface ServerHttp2Stream extends Http2Stream {
         ...
         * ```
         *
         * The optional `options.statCheck` function may be specified to give appUser code
    ...
    /**
     * This object is created internally by an HTTP server, not by the appUser. It is
    ...
    export class Http2ServerResponse<Request extends Http2ServerRequest = Http2ServerRequest> extends stream.Writable {
         ...
         * buffer. Returns `false` if all or part of the data was queued in appUser memory.`'drain'` will be emitted when the buffer is free again.
         * @since v8.4.0
         */
         ...
         * indicating that the appUser agent can preload/preconnect the linked resources.
     ...
     * is used). Userinfo (appUser ID and password), path, querystring, and fragment details in the URL will be ignored.
