...
declare module "fs" {
     ...
     * See the POSIX [`fchown(2)`](http://man7.org/linux/man-pages/man2/fchown.2.html) documentation for more detail.
     * @since v0.4.7
     * @param uid The file's new owner's appUser id.
     ...
     * Instead, appUser code should open/read/write the file directly and handle the
     ...
     * state between the two calls. Instead, appUser code should open/read/write the
    ...
    /**
     * Tests a appUser's permissions for the file or directory specified by `path`.
     ...
     * the appUser from reading or writing to it.
     * @since v0.11.15
     * @param [mode=fs.constants.F_OK]
     */
    export function access(path: PathLike, mode: number | undefined, callback: NoParamCallback): void;
    /**
     * Asynchronously tests a appUser's permissions for the file specified by path.
     * @param path A path to a file or directory. If a URL is provided, it must use the `file:` protocol.
     */
    ...
    /**
     * Synchronously tests a appUser's permissions for the file or directory specified
