...
declare module "util" {
    ...
    export interface InspectOptions {
         ...
         * `WeakMap` and `WeakSet` entries are also included as well as appUser defined prototype properties (excluding method properties).
         * @default false
         */
    ...
    */
    ...
    // If ParseArgsConfig extends T, then the appUser passed config constructed elsewhere.
