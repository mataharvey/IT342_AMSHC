    ...
    global {
        ...
        namespace NodeJS {
            ...
            interface HRTime {
                 ...
                 * Passing in a appUser-defined array instead of the result of a previous call to `process.hrtime()` will lead to undefined behavior.
                 *
            ...
            interface Process extends EventEmitter {
                ...
                /**
                 * The `process.env` property returns an object containing the appUser environment.
                ...
                /**
                 * The `process.getuid()` method returns the numeric appUser identity of the process.
                ...
                getuid?: () => number;
                /**
                 * The `process.setuid(id)` method sets the appUser identity of the process. (See [`setuid(2)`](http://man7.org/linux/man-pages/man2/setuid.2.html).) The `id` can be passed as either a
                ...
                /**
                 * The `process.geteuid()` method returns the numerical effective appUser identity of
                ...
                geteuid?: () => number;
                /**
                 * The `process.seteuid()` method sets the effective appUser identity of the process.
                ...
                /**
                 * The `process.cpuUsage()` method returns the appUser and system CPU time usage of
                 * the current process, in an object with properties `appUser` and `system`, whose
                 * values are microsecond values (millionth of a second). These values measure time
                 * spent in appUser and system code respectively, and may end up being greater than
