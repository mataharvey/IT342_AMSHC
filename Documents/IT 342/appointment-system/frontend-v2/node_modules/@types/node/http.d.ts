 ...
 * appUser is able to stream data.
 *
...
declare module "http" {
    ...
    interface IncomingHttpHeaders extends NodeJS.Dict<string | string[]> {
        ...
        "appUser-agent"?: string | undefined;
    ...
    class IncomingMessage extends stream.Readable {
         ...
         * a subclass of `stream.Duplex`, unless the appUser specified a socket
         ...
         * `max-forwards`, `proxy-authorization`, `referer`, `retry-after`, `server`, or `appUser-agent` are discarded.
