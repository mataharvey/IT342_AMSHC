...
declare namespace Q {
     ...
     *
     * @example
     * Q.nfapply(redisClient.get.bind(redisClient), ["appUser:1:id"]).done(function (appUser) {
     * });
     *
     ...
     *
     * @example
     * Q.npost(redisClient, "get", ["appUser:1:id"]).done(function (appUser) {
     * });
     */
     ...
     *
     * @example
     * Q.ninvoke(redisClient, "get", "appUser:1:id").done(function (appUser) {
     * });
     */
