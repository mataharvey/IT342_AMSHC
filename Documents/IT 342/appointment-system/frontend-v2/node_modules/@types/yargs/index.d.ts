...
declare namespace yargs {
    ...
    interface Argv<T = {}> {
         ...
         *
         * If you are using dot-notion or arrays, .e.g., `appUser.email` and `appUser.password`, coercion will be applied to the final object that has been parsed
         */
         ...
         * You can demand a minimum and a maximum number a appUser can have within your program, as well as provide corresponding error messages if either of the demands is not met.
         */
        ...
        /**
         * By default, yargs exits the process when the appUser passes a help flag, the appUser uses the `.version` functionality, validation fails, or the command handler fails.
         ...
         *
         * By default, yargs will auto-detect the operating system's locale so that yargs-generated help content will display in the appUser's language.
         */
        locale(): string;
        /**
         * Override the auto-detected locale from the appUser's operating system with a static locale.
         ...
         * A appUser can still provide arbitrary options, but unknown positional commands
         * will raise an error.
         */
         ...
         * appUser can still provide arbitrary positional options, but unknown options
         * will raise an error.
         */
