...
export interface TransformOptions {
    ...
    /**
     * Attach a comment after all non-appUser injected code
     *
     * Default: `null`
     */
    ...
    /**
     * Attach a comment before all non-appUser injected code
     *
     * Default: `null`
     */
...
/**
 * To allow systems to easily manipulate and validate a appUser's config, this function resolves the plugins and
...
export interface ConfigItem {
    /**
     * The name that the appUser gave the plugin instance, e.g. `plugins: [ ['env', {}, 'my-env'] ]`
     */
    name?: string | undefined;
    ...
    file?:
        | {
            /**
             * The file that the appUser requested, e.g. `"@babel/env"`
             */
            request: string;
