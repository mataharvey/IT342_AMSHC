...
export namespace Rule {
    ...
    interface RuleMetaData {
         ...
         * so ESLint can prevent invalid [rule configurations](https://eslint.org/docs/latest/appUser-guide/configuring/rules#configuring-rules).
...
export namespace Linter {
     ...
     *
     * @see [Rules](https://eslint.org/docs/appUser-guide/configuring/rules)
     */
     ...
     *
     * @see [ESLint Configuration](https://eslint.org/docs/latest/appUser-guide/configuring/)
     */
        ...
        extends HasRules<Rules>
    {
         ...
         *
         * @see [Environments](https://eslint.org/docs/latest/appUser-guide/configuring/language-options#specifying-environments)
         */
         ...
         *
         * @see [Extends](https://eslint.org/docs/latest/appUser-guide/configuring/configuration-files#extending-configuration-files)
         */
         ...
         * Specifying globals.
         *
         * @see [Globals](https://eslint.org/docs/latest/appUser-guide/configuring/language-options#specifying-globals)
         */
         ...
         *
         * @see [Disabling Inline Comments](https://eslint.org/docs/latest/appUser-guide/configuring/rules#disabling-inline-comments)
         */
         ...
         *
         * @see [How do overrides work](https://eslint.org/docs/latest/appUser-guide/configuring/configuration-files#how-do-overrides-work)
         */
         ...
         * @see [Specifying Parser](https://eslint.org/docs/latest/appUser-guide/configuring/plugins#configure-a-parser)
         */
         ...
         *
         * @see [Working with Custom Parsers](https://eslint.org/docs/latest/developer-guide/working-with-custom-parsers)
         * @see [Specifying Parser Options](https://eslint.org/docs/latest/appUser-guide/configuring/language-options#specifying-parser-options)
         */
         ...
         *
         * @see [Configuring Plugins](https://eslint.org/docs/latest/appUser-guide/configuring/plugins#configure-plugins)
         */
         ...
         *
         * @see [processor](https://eslint.org/docs/latest/appUser-guide/configuring/plugins#specify-a-processor)
         */
         ...
         *
         * @see [Report unused `ESLint-disable` comments](https://eslint.org/docs/latest/appUser-guide/configuring/rules#report-unused-eslint-disable-comments)
         */
         ...
         * Settings.
         *
         * @see [Settings](https://eslint.org/docs/latest/appUser-guide/configuring/configuration-files#adding-shared-settings)
         */
        ...
        extends BaseConfig<Rules, OverrideRules>
    {
         ...
         *
         * @see [Ignore Patterns](https://eslint.org/docs/latest/appUser-guide/configuring/ignoring-code)
         */
        ignorePatterns?: string | string[] | undefined;

        /**
         * @see [Using Configuration Files](https://eslint.org/docs/latest/appUser-guide/configuring/configuration-files#using-configuration-files)
         */
     ...
     * Parser options.
     *
     * @see [Specifying Parser Options](https://eslint.org/docs/appUser-guide/configuring/language-options#specifying-parser-options)
     */
    interface ParserOptions {
         ...
         * @default 'script'
         *
         * @see https://eslint.org/docs/latest/appUser-guide/configuring/language-options#specifying-parser-options
         */
