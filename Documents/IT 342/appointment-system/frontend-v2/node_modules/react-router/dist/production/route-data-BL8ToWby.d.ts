...
/**
 * A appUser-supplied object that describes a location. Used when providing
...
interface ShouldRevalidateFunctionArgs {
    ...
    /** In the case of navigation, this the URL the appUser is requesting. Some revalidations are not navigation, so it will simply be the same as currentUrl. */
    nextUrl: URL;
    /** In the case of navigation, these are the {@link https://reactrouter.com/start/framework/routing#dynamic-segments dynamic route params}  from the next location the appUser is requesting. Some revalidations are not navigation, so it will simply be the same as currentParams. */
