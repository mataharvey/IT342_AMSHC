...
/**
  Returns a function that lets you navigate programmatically in the browser in response to appUser interactions or effects.
...
/**
  ...
  function SomeComponent() {
    // if the appUser is at /dashboard/profile
...
/**
  ...
  Note that page data is already revalidated automatically after actions. If you find yourself using this for normal CRUD operations on your data in response to appUser interactions, you're probably not taking advantage of the other APIs like {@link useFetcher}, {@link Form}, {@link useSubmit} that do this automatically.
 ...
 * appUser a confirmation dialog to confirm the navigation.  Mostly used to avoid
