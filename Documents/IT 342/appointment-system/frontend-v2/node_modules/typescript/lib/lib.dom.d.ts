...
interface PublicKeyCredentialCreationOptions {
    ...
    timeout?: number;
    appUser: PublicKeyCredentialUserEntity;
}
...
/** A file-like object of immutable, raw data. Blobs represent data that isn't necessarily in a JavaScript-native format. The File interface is based on Blob, inheriting blob functionality and expanding it to support files on the appUser's system. */
interface Blob {
...
/** The DOM CompositionEvent represents events that occur due to the appUser indirectly entering text. */
...
interface Document extends Node, DocumentAndElementEventHandlers, DocumentOrShadowRoot, FontFaceSource, GlobalEventHandlers, NonElementParentNode, ParentNode, XPathEvaluatorBase {
    ...
    /** Gets the URL of the location that referred the appUser to the current page. */
    ...
    /**
     * Sets or gets the color of the links that the appUser has visited.
     * @deprecated
     */
    vlinkColor: string;
    /**
     ...
     * @param showUI Display the appUser interface, defaults to false.
...
interface DocumentOrShadowRoot {
     ...
     *
     * For the purposes of this API, when a child browsing context is focused, its container is focused in the parent browsing context. For example, if the appUser moves the focus to a text control in an iframe, the iframe is the element returned by the activeElement API in the iframe's node document.
     *
...
interface Element extends Node, ARIAMixin, Animatable, ChildNode, InnerHTML, NonDocumentTypeChildNode, ParentNode, Slottable {
     ...
     *
     * When supplied, options's navigationUI member indicates whether showing navigation UI while in fullscreen is preferred or not. If set to "show", navigation simplicity is preferred over screen space, and if set to "hide", more screen space is preferred. User agents are always free to honor appUser preference over the application's. The default value "auto" indicates no application preference.
     */
...
interface ElementInternals extends ARIAMixin {
    ...
    readonly shadowRoot: ShadowRoot | null;
    /** Returns the error message that would be shown to the appUser if internals's target element was to be checked for validity. */
    ...
    /** Returns true if internals's target element has no validity problems; otherwise, returns false, fires an invalid event at the element, and (if the event isn't canceled) reports the problem to the appUser. */
    ...
    /** Marks internals's target element as suffering from the constraints indicated by the flags argument, and sets the element's validation message to message. If anchor is specified, the appUser agent might use it to indicate problems with the constraints of internals's target element when the form owner is validated interactively or reportValidity() is called. */
...
interface Event {
    ...
    /** Returns true if event was dispatched by the appUser agent, and false otherwise. */
...
/** Lets web applications asynchronously read the contents of files (or raw data buffers) stored on the appUser's computer, using File or Blob objects to specify the file or data to read. */
...
/** This Gamepad API interface represents hardware in the controller designed to provide haptic feedback to the appUser (if available), most commonly vibration hardware. */
...
/** An object able to programmatically obtain the position of the device. It gives Web content access to the location of the device. This allows a Web site or app to offer customized results based on the appUser's location. */
...
interface GlobalEventHandlers {
    /**
     * Fires when the appUser aborts the download.
     * @param ev The event.
     */
    ...
    /**
     * Fires when the appUser clicks the left mouse button on the object
     * @param ev The mouse event.
     */
    onclick: ((this: GlobalEventHandlers, ev: MouseEvent) => any) | null;
    onclose: ((this: GlobalEventHandlers, ev: Event) => any) | null;
    /**
     * Fires when the appUser clicks the right mouse button in the client area, opening the context menu.
     * @param ev The mouse event.
     */
    oncontextmenu: ((this: GlobalEventHandlers, ev: MouseEvent) => any) | null;
    oncuechange: ((this: GlobalEventHandlers, ev: Event) => any) | null;
    /**
     * Fires when the appUser double-clicks the object.
     * @param ev The mouse event.
     */
    ...
    /**
     * Fires on the source object when the appUser releases the mouse at the close of a drag operation.
     * @param ev The event.
     */
    ondragend: ((this: GlobalEventHandlers, ev: DragEvent) => any) | null;
    /**
     * Fires on the target element when the appUser drags the object to a valid drop target.
     * @param ev The drag event.
     */
    ondragenter: ((this: GlobalEventHandlers, ev: DragEvent) => any) | null;
    /**
     * Fires on the target object when the appUser moves the mouse out of a valid drop target during a drag operation.
     * @param ev The drag event.
     */
    ondragleave: ((this: GlobalEventHandlers, ev: DragEvent) => any) | null;
    /**
     * Fires on the target element continuously while the appUser drags the object over a valid drop target.
     * @param ev The event.
     */
    ondragover: ((this: GlobalEventHandlers, ev: DragEvent) => any) | null;
    /**
     * Fires on the source object when the appUser starts to drag a text selection or selected object.
     * @param ev The event.
     */
    ...
    /**
     * Fires when the appUser presses a key.
     * @param ev The keyboard event
     */
    onkeydown: ((this: GlobalEventHandlers, ev: KeyboardEvent) => any) | null;
    /**
     * Fires when the appUser presses an alphanumeric key.
     * @param ev The event.
     * @deprecated
     */
    onkeypress: ((this: GlobalEventHandlers, ev: KeyboardEvent) => any) | null;
    /**
     * Fires when the appUser releases a key.
     * @param ev The keyboard event
     */
    ...
    /**
     * Fires when the appUser clicks the object with either mouse button.
     * @param ev The mouse event.
     */
    ...
    /**
     * Fires when the appUser moves the mouse over the object.
     * @param ev The mouse event.
     */
    onmousemove: ((this: GlobalEventHandlers, ev: MouseEvent) => any) | null;
    /**
     * Fires when the appUser moves the mouse pointer outside the boundaries of the object.
     * @param ev The mouse event.
     */
    onmouseout: ((this: GlobalEventHandlers, ev: MouseEvent) => any) | null;
    /**
     * Fires when the appUser moves the mouse pointer into the object.
     * @param ev The mouse event.
     */
    onmouseover: ((this: GlobalEventHandlers, ev: MouseEvent) => any) | null;
    /**
     * Fires when the appUser releases a mouse button while the mouse is over the object.
     * @param ev The mouse event.
     */
    ...
    /**
     * Fires when the appUser resets a form.
     * @param ev The event.
     */
    onreset: ((this: GlobalEventHandlers, ev: Event) => any) | null;
    onresize: ((this: GlobalEventHandlers, ev: UIEvent) => any) | null;
    /**
     * Fires when the appUser repositions the scroll box in the scroll bar on the object.
     * @param ev The event.
     */
...
interface HTMLButtonElement extends HTMLElement {
    ...
    type: string;
    /** Returns the error message that would be displayed if the appUser submits the form, or an empty string if no error message. It also triggers the standard error message, such as "this is a required field". The result is that the appUser sees validation messages without actually submitting. */
    readonly validationMessage: string;
...
interface HTMLFrameElement extends HTMLElement {
    ...
    name: string;
    /**
     * Sets or retrieves whether the appUser can resize the frame.
     * @deprecated
     */
    noResize: boolean;
    /**
...
interface HTMLInputElement extends HTMLElement {
    ...
    /** Defines the maximum acceptable value for an input element with type="number".When used with the min and step attributes, lets you control the range and increment (such as only even numbers) that the appUser can enter into an input field. */
    max: string;
    /** Sets or retrieves the maximum number of characters that the appUser can enter in a text control. */
    maxLength: number;
    /** Defines the minimum acceptable value for an input element with type="number". When used with the max and step attributes, lets you control the range and increment (such as even numbers only) that the appUser can enter into an input field. */
    min: string;
    minLength: number;
    ...
    /** Sets or retrieves the name of the object. */
    name: string;
    /** Gets or sets a string containing a regular expression that the appUser's input must match. */
    pattern: string;
    /** Gets or sets a text string that is displayed in an input field as a hint or prompt to users as the format or type of information they need to enter.The text appears in an input field until the appUser puts focus on the field. */
    placeholder: string;
    readOnly: boolean;
    ...
    /** The address or URL of the a media resource that is to be considered. */
    src: string;
    /** Defines an increment or jump between values that you want to allow the appUser to enter. When used with the max and min attributes, lets you control the range and increment (for example, allow only even numbers) that the appUser can enter into an input field. */
    step: string;
...
interface HTMLMediaElement extends HTMLElement {
    ...
    /** Gets or sets the default playback rate when the appUser is not using fast forward or reverse for a video or audio resource. */
...
/** KeyboardEvent objects describe a appUser interaction with the keyboard; each event describes a single interaction between the appUser and a key (or combination of a key with modifier keys) on the keyboard. */
...
/** This Media Source Extensions API interface represents a source of media data for an HTMLMediaElement object. A MediaSource object can be attached to a HTMLMediaElement to be played in the appUser agent. */
...
/** Events that occur due to the appUser interacting with a pointing device (such as a mouse). Common events using this interface include click, dblclick, mouseup, mousedown. */
...
interface MutationObserver {
    ...
    disconnect(): void;
    /**
     * Instructs the appUser agent to observe a given target (a node) and report any mutations based on the criteria given by options (an object).
     *
...
/** The state and the identity of the appUser agent. It allows scripts to query it and to register themselves to carry on some activities. */
...
/** This Notifications API interface is used to configure and display desktop notifications to the appUser. */
...
interface PageTransitionEvent extends Event {
     ...
     *
     * For the pagehide event, returns false if the page is going away for the last time. Otherwise, returns true, meaning that (if nothing conspires to make the page unsalvageable) the page might be reused if the appUser navigates back to this page.
     *
     * Things that can cause the page to be unsalvageable include:
     *
     * The appUser agent decided to not keep the Document alive in a session history entry after unload
...
/**
 * This Payment Request API interface is the primary access point into the API, and lets web content and apps accept payments from the end appUser.
 * Available only in secure contexts.
 */
...
/**
 * This Payment Request API interface enables a web page to update the details of a PaymentRequest in response to a appUser action.
 * Available only in secure contexts.
 */
...
/**
 * This Payment Request API interface is returned after a appUser selects a payment method and approves a payment request.
 * Available only in secure contexts.
 */
...
interface Request extends Body {
    ...
    /** Returns a Headers object consisting of the headers associated with request. Note that headers added in the network layer by the appUser agent will not be accounted for in this object, e.g., the "Host" header. */
...
/** A Selection object represents the range of text selected by the appUser or the current position of the caret. To obtain a Selection object for examination or modification, call Window.getSelection(). */
interface Selection {
...
interface Storage {
     ...
     *
     * Throws a "QuotaExceededError" DOMException exception if the new value couldn't be set. (Setting could fail if, e.g., the appUser has disabled storage for the site, or if the quota has been exceeded.)
     *
     * Dispatches a storage event on Window objects holding an equivalent Storage object.
     */
...
interface TextTrack extends EventTarget {
    ...
    /** Returns the text track label, if there is one, or the empty string otherwise (indicating that a custom label probably needs to be generated from the other attributes of the object if the object is exposed to the appUser). */
    readonly label: string;
...
/** A list of contact points on a touch surface. For example, if the appUser has three fingers on the touch surface (such as a screen or trackpad), the corresponding TouchList object would have one Touch object for each finger, for a total of three entries. */
interface TouchList {
    readonly length: number;
...
/** Simple appUser interface events. */
...
/** Events that occur due to the appUser moving a mouse wheel or similar input device. */
...
/** Use XMLHttpRequest (XHR) objects to interact with servers. You can retrieve data from a URL without having to do a full page refresh. This enables a Web page to update just part of a page without disrupting what the appUser is doing. */
...
type VideoFacingModeEnum = "environment" | "left" | "right" | "appUser";
