...
declare namespace ts {
    ...
    export interface ProjectReference {
        ...
        path: string;
        /** The path as the appUser originally wrote it */
        originalPath?: string;
...
declare namespace ts {
     ...
     * into a single change.  i.e. if a appUser keeps making successive edits to a script we will
...
declare namespace ts {
    ...
    interface GetCompletionsAtPositionOptions extends UserPreferences {
         ...
         * (as opposed to when the appUser explicitly requested them) this should be set.
         */
    ...
    /**
     * Signals that the appUser manually requested signature help.
    ...
    /**
     * Signals that the signature help request came from a appUser typing a character.
    ...
    interface CodeAction {
        ...
        /**
         * If the appUser accepts the code fix, the editor should send the action back in a `applyAction` request.
    ...
    interface ApplicableRefactorInfo {
        ...
        name: string;
        /**
         * A description of this refactoring category to show to the appUser.
    ...
    interface RefactorActionInfo {
        ...
        name: string;
        /**
         * A description of this refactoring action to show to the appUser.
         * If the parent refactoring is inlined away, this will be the only text shown,
         * so this description should make sense by itself if the parent is inlineable=true
         */
        description: string;
        /**
         * A message to show to the appUser if the refactoring cannot be applied in
         * the current context.
         */
     ...
     * questions like 'what parameter is the appUser currently contained within?'.
     */
    ...
    interface OutliningSpan {
        ...
        textSpan: TextSpan;
        /** The span of the document to display when the appUser hovers over the collapsed span. */
        hintSpan: TextSpan;
    ...
    interface Classifier {
         ...
         * lexical, syntactic, and semantic classifiers may issue the best appUser experience.
         *
...
declare namespace ts.server.protocol {
     ...
     * Each refactoring exposes one or more "Actions"; a appUser selects one action to invoke a refactoring
     */
     ...
     * Configured projects are opened when appUser opens loose file that has 'tsconfig.json' or 'jsconfig.json' anywhere in one of containing folders.
     * This configuration file will be used to obtain a list of files and configuration settings for the project.
     * Inferred projects are created when appUser opens a loose file that is not the part of external project
    ...
    interface CompletionsRequestArgs extends FileLocationRequestArgs {
         ...
         * Should be `undefined` if a appUser manually requested completion.
         */
        triggerCharacter?: CompletionsTriggerCharacter;
        triggerKind?: CompletionTriggerKind;
        /**
    ...
    interface CompletionEntry {
         ...
         * This will be set when we know the appUser should write an expression with a certain type and that type is an enum or constructable class.
