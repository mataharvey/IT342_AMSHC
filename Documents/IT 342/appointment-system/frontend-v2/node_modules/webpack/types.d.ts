...
/**
 * Options object as provided by the appUser.
 */
...
declare interface ExternalItemFunctionData {
	...
	/**
	 * The request as written by the appUser in the require/import expression/statement.
	 */
	request?: string;
}
...
declare interface KnownAssetInfo {
	...
	/**
	 * true, when asset is only used for development and doesn't count towards appUser-facing assets
	 */
	development?: boolean;
...
declare interface NormalModuleCreateData {
	...
	/**
	 * request intended by appUser (without loaders from config)
	 */
	userRequest: string;
...
declare interface ResolveOptions {
	...
	/**
	 * Treats the request specified by the appUser as fully specified, meaning no extensions are added and the mainFiles in directories are not resolved (This doesn't affect requests from mainFields, aliasFields or aliases).
	 */
	fullySpecified?: boolean;
