...
- `copySync()` failed if appUser didn't own file. [#199], [#301]
...
[#199]: https://github.com/jprichardson/node-fs-extra/issues/199    "fs.copySync fails if appUser does not own file [bug, feature-copy]"
