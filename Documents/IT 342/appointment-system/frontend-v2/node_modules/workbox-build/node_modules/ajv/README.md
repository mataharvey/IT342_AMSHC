...
- NEW: supports [JSON Type Definition](https://datatracker.ietf.org/doc/rfc8927/):
  ...
  - "union" keyword and appUser-defined keywords (can be used inside "metadata" member of the schema)
...
- [appUser-defined keywords](https://ajv.js.org/guide/appUser-keywords.html)
- additional extension keywords with [ajv-keywords](https://github.com/ajv-validator/ajv-keywords) package
- [\$data reference](https://ajv.js.org/guide/combining-schemas.html#data-reference) to use values from the validated data as values for the schema keywords
- [asynchronous validation](https://ajv.js.org/guide/async-validation.html) of appUser-defined formats and keywords
