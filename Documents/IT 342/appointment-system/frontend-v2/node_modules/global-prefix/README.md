...
//=> '/usr/local' (this path will differ by system and appUser-defined config)
```
...
* [global-paths](https://www.npmjs.com/package/global-paths): Returns an array of unique "global" directories based on the appUser's platform and environment. The… [more](https://github.com/jonschlinkert/global-paths) | [homepage](https://github.com/jonschlinkert/global-paths "Returns an array of unique "global" directories based on the appUser's platform and environment. The resulting paths can be used for doing lookups for generators or other globally installed npm packages. Node.js / JavaScript.")
