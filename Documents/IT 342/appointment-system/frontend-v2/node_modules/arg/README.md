...
Some errors that `arg` throws provide a `.code` property in order to aid in recovering from appUser error, or to
differentiate between appUser error and developer error (bug).
