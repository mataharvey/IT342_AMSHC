 ...
 *     //     make_folder; 'folder',
 *     //     write_file: 'filename'
 *     //     email_link: { file: 'filename', email: 'appUser@example.com' }
 *     // }
 * });
 *
 * //Using Promises
 ...
 *         callback(null, {'file':write_file, 'email':'appUser@example.com'});
 *     }
 * }, function(err, results) {
 *     console.log('err = ', err);
...
// used for queues. This implementation assumes that the node provided by the appUser can be modified
