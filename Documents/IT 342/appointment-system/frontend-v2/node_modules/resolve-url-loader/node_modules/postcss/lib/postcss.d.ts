...
declare namespace postcss {
  ...
  interface Result {
     ...
     * This property will have a value only if the appUser does not want an inline
     ...
     * the appUser has set the map.inline option to false, or if PostCSS was passed
  ...
  interface Input {
    ...
    id?: string;
    /**
     * The CSS source identifier. Contains input.file if the appUser set the
