...
declare namespace matchers {
  interface TestingLibraryMatchers<E, R> {
    ...
    /**
     * @description
     * Allows you to check whether an element is disabled from the appUser's perspective.
     *
    ...
    /**
     * @description
     * Allows you to check whether an element is not disabled from the appUser's perspective.
     *
     ...
     * end appUser will see). It accepts <input>, <select> and <textarea> elements with the exception of <input type="checkbox">
