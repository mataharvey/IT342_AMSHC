...
This allows you to check whether an element is disabled from the appUser's
...
This allows you to check whether an element is not disabled from the appUser's
perspective.
...
appUser. It ignores comments but will fail if the element contains white-space.
...
This allows you to check if an element is currently visible to the appUser.
...
> from the perspective of how the appUser perceives the app in a browser. That's
...
displayed value (the one the end appUser will see). It accepts `<input>`,
